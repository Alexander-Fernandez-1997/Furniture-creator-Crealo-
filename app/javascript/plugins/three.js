...
//       shelf1.position.y =
//         bspy + sha * 1 - ((200 - height.value) / 10) * (1 / sc);
//       shelf2.position.y =
//         bspy + sha * 2 - ((200 - height.value) / 10) * (2 / sc);
//       shelf3.position.y =
//         bspy + sha * 3 - ((200 - height.value) / 10) * (3 / sc);
//       shelf4.position.y =
//         bspy + sha * 4 - ((200 - height.value) / 10) * (4 / sc);
//       shelf5.position.y =
//         bspy + sha * 5 - ((200 - height.value) / 10) * (5 / sc);
//       shelf6.position.y =
//         bspy + sha * 6 - ((200 - height.value) / 10) * (6 / sc);
//       shelf7.position.y =
//         bspy + sha * 7 - ((200 - height.value) / 10) * (7 / sc);
//       shelf8.position.y =
//         bspy + sha * 8 - ((200 - height.value) / 10) * (8 / sc);
//       shelf9.position.y =
//         bspy + sha * 9 - ((200 - height.value) / 10) * (9 / sc);
//       shelf10.position.y =
